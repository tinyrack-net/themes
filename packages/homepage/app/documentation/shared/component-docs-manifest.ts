...
export const componentDocsManifest = [
  {
    ...
    id: 'accordion',
    controls: ['disabledItem', 'multiple', 'rootDisabled'],
  ...
  },
  {
    ...
    id: 'alert',
    controls: ['description', 'title', 'variant'],
    requiredExamples: [
      'alert-basic',
      'alert-variants',
      'alert-role-recipe',
  ...
  },
  {
    ...
    id: 'app-shell',
    controls: ['breakpoint', 'layout', 'mobileSidebar'],
  ...
  },
  {
    ...
    id: 'field',
    controls: ['disabled', 'invalid', 'label', 'size'],
    requiredExamples: [
      'field-basic',
      'field-field-states',
      'field-validation',
  ...
  },
  {
    ...
    id: 'tabs',
    controls: ['disabled', 'orientation', 'uiSize'],
    requiredExamples: [
      'tabs-basic',
      'tabs-sizes',
      'tabs-vertical',
  ...
  },
  {
    ...
    id: 'checkbox',
    controls: ['label', 'disabled', 'indeterminate', 'readOnly', 'uiSize'],
    requiredExamples: [
      'checkbox-basic',
      'checkbox-states',
      'checkbox-validation',
  ...
  },
  {
    ...
    id: 'docs-navigation',
    controls: ['currentPath', 'pendingPath'],
