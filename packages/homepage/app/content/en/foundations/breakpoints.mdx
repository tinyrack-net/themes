...
Tinyrack publishes `--breakpoint-xs` through `--breakpoint-xl` as Tailwind theme variables. TypeScript exposes the same values as `tinyrackBreakpoints`. They do not create CSS custom media rules.
