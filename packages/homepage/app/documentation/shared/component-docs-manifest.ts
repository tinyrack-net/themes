...
export const componentDocsManifest = [
  ...
  {
    capabilities: ['responsive', 'keyboard'],
    file: 'app/content/en/components/link-button.mdx',
    id: 'link-button',
    controls: ['appearance', 'disabled', 'intent', 'uiSize'],
    exampleGroups: [
      exampleGroup('link-button-basic', 'usage', 'basic', 1),
      exampleGroup('link-button-solid-intents', 'examples', 'series', 6),
      exampleGroup('link-button-outline-intents', 'examples', 'series', 6),
      exampleGroup('link-button-ghost-intents', 'examples', 'series', 6),
      exampleGroup('link-button-sizes', 'examples', 'series', 3),
      exampleGroup('link-button-states', 'examples', 'series', 3),
    ],
    requiredExamples: [
      'link-button-basic',
      'link-button-solid-intents',
      'link-button-outline-intents',
      'link-button-ghost-intents',
      'link-button-sizes',
      'link-button-states',
    ],
    title: 'LinkButton',
