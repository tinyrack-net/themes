...
<ComponentExampleTabs id="file-tree-basic" title="Project files" preview={<Stories.FileTreePreview />} sources={[{ label: 'MDX', language: 'mdx', code: Stories.fileTreeBasicSource }]} />
...
<ComponentExampleTabs id="file-tree-authored-content" title="Paths, Markdown, and placeholders" preview={<Stories.FileTreeAuthoredContentPreview />} sources={[{ label: 'MDX', language: 'mdx', code: Stories.fileTreeAuthoredContentSource }]} />
