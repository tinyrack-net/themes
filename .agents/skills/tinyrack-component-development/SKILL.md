...
description: Develop, change, document, test, review, package, or publish Tinyrack UI components using the repository's Web Platform-first architecture, framework-neutral DOM behavior, React adapter boundaries, color-token rules, package exports, Storybook documentation, browser parity suites, coverage requirements, and release checks. Use for any task that touches a component contract, component CSS, DOM manager, React adapter, component documentation, component packaging, or component test coverage in the Tinyrack UI repository.
---
